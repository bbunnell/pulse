  ...
  if (body.sendEmail) {
    await sendTransactionalEmail({
      ...
      text: [
        ...
        ``,
        `An admin has reset your Team Pulse password. Use the temporary password below to sign in,`,
      ...
      html: `
        <table style="font-family:sans-serif;font-size:14px;color:#111;max-width:500px">
          <tr><td style="padding-bottom:16px">
            <strong style="font-size:16px">Team Pulse — Password Reset</strong>
          </td></tr>
          ...
          <tr><td style="background:#f8fafc;border:1px solid #e2e8f0;border-radius:8px;padding:14px 18px;margin-bottom:16px">
            ...
            <div style="font-family:monospace;font-size:20px;font-weight:700;letter-spacing:2px;color:#3730a3;background:#E6F0FA;display:inline-block;padding:6px 12px;border-radius:5px">${tempPassword}</div>
          </td></tr>
          <tr><td style="padding-top:12px">
            <a href="${baseUrl}/login" style="background:#00579D;color:#fff;padding:10px 20px;border-radius:6px;text-decoration:none;font-weight:600;display:inline-block">Sign in to Team Pulse</a>
          </td></tr>
        </table>`,
    });
  }
