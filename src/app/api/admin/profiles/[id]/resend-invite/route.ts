...
function buildPlainText(firstName: string, email: string, password: string, loginUrl: string) {
  return [
    `Hi ${firstName},`,
    ``,
    `Here are your Team Pulse account details${password ? " (your password has been reset)" : ""}.`,
    ``,
    `  Login:    ${loginUrl}`,
    `  Email:    ${email}`,
    `  Password: ${password}`,
...
<table width="560" cellpadding="0" cellspacing="0" style="background:#fff;border-radius:10px;overflow:hidden;box-shadow:0 1px 4px rgba(0,0,0,.08);">
  ...
  <tr><td style="padding:28px 32px 0;">
    ...
    <table cellpadding="0" cellspacing="0" style="background:#f8fafc;border:1px solid #e2e8f0;border-radius:8px;padding:16px 20px;width:100%;">
      <tr>
        ...
        <td style="font-size:13px;"><a href="${loginUrl}" style="color:#00579D;">${loginUrl}</a></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td><span style="font-family:monospace;font-size:16px;font-weight:700;letter-spacing:2px;background:#E6F0FA;color:#133F62;padding:4px 10px;border-radius:5px;">${password}</span></td>
      </tr>
    </table>
  ...
  <tr><td style="padding:20px 32px 0;">
    ...
    <ol style="margin:0;padding-left:18px;font-size:13px;color:#334155;line-height:1.7;">
      <li>Go to <a href="https://make.powerautomate.com" style="color:#00579D;">make.powerautomate.com</a> and sign in with your NBIT account.</li>
      <li>Click <strong>New flow → Instant cloud flow</strong>. Name it <em>"Team Pulse Reminder"</em>.</li>
  ...
  <tr><td style="padding:24px 32px 28px;">
    ...
    <p style="margin:0;font-size:12px;color:#94a3b8;">This is an automated message from Team Pulse.</p>
  </td></tr>
</table>
</td></tr>
</table>
